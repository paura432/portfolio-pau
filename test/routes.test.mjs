...
test('professional routes and technical routes exist', () => {
  for (const path of ['app/work/ovi/page.tsx', 'app/work/duplex/page.tsx', 'app/work/trustos/page.tsx', 'app/work/broki/page.tsx', 'app/foundations/cub3d/page.tsx', 'app/foundations/minishell/page.tsx', 'app/colophon/page.tsx']) assert.match(read(path), /export default function/)
})
