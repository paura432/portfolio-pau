...
| OVI | Husky pre-commit gates and Playwright browser checks. | User-confirmed; checkout absent | USER_CONFIRMED | Yes | No exact commands without source. |
| DUPLEX | Husky pre-commit gates and Playwright browser checks. | User-confirmed; checkout absent | USER_CONFIRMED | Yes | No exact commands without source. |
